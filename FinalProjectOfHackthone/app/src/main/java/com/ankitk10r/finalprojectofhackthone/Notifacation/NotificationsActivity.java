...
import com.ankitk10r.finalprojectofhackthone.TabMenu.RecyclerAdapter.waste_cat_Recycler_Adapter;
import com.ankitk10r.finalprojectofhackthone.databinding.ActivityNotificationsBinding;
...
public class NotificationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.notificationRecycler.setLayoutManager( new LinearLayoutManager( getApplicationContext(),LinearLayoutManager.VERTICAL,false ) );
        adapter = new notificationAdapter(getApplicationContext(),sellModelClasses);
        binding.notificationRecycler.setAdapter(adapter);

        binding.notificationCloseBtn.setOnClickListener( new View.OnClickListener() {
            @Override
